...
@registry.register_model("aff_phi3")
class AffordancePhi3(BaseModel):
    ...
    def __init__(
        ...
        llm_model_type=None,
        use_predefined_affordance_token=False,
        **kwargs,
    ):
        super().__init__()
        # Set Precision
        ...
        self.use_predefined_affordance_token = use_predefined_affordance_token
        ...
        if self.llm_model_type == "phi3.5" and self.use_predefined_affordance_token:
    ...
    def from_config(cls, cfg):
        ...
        use_predefined_affordance_token = cfg.get("use_predefined_affordance_token", False)
        ...
        model = cls(
            ...
            use_predefined_affordance_token=use_predefined_affordance_token,
        )
