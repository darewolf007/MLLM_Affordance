...
@registry.register_model("aff_phi_cot_single")
class AffordancePhiCS(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #     self.seg_token_id_2,
        #     self.seg_token_id_3
        # ] 生成时三个token均生成，但是只取SEG_TOKEN1 = "<SEG_Global>"token用于后续decoder
        self.seg_token_ids = [self.seg_token_id_1]
    ...
    def predict_mask(
        ...
        for i in range(bs):
            ...
            pred_tokens = torch.stack(pred_tokens, dim=0).squeeze(1)  # [1, C]
            # pred_tokens = pred_tokens.unsqueeze(0)           # [1, 1, C]
