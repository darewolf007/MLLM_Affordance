...
class AffordancePhi(BaseModel):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "phi": "3D_ADLLM/configs/models/point_phi3.yaml",
        "phi4": "3D_ADLLM/configs/models/point_phi4.yaml",
    }
    ...
    def generate(
        ...
        for i in range(bs):
            ...
            # res = (
            #     res + 
            #     "请根据上述文本描述，找到与之对应的点云区域。在输出中添加特殊token <SEG> 作为区域标识。"
            # )
            new_questions.append(res)
