...
def parse_args():
    ...
    parser.add_argument("--cfg-path", help="path to configuration file.", default='/data1/user/zhangshaolong/3D_ADLLM/configs/phi_train/shape_omni/phi4_multi_shapeomni_train.yaml')
...
def main():
    ...
    eval_datasets, task_evals = None, None
